...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item Multiplicación por un escalar: \( \alpha \ket{\varphi} \in \mathcal{H}, \qquad \forall \ket{\varphi}, \in \mathcal{H} \quad \text{y} \quad \forall \alpha \in \mathbb{C}\)
    ...
    \vspace{2mm}
    \begin{equation}
        \braket{n | m} = \delta_{n, m}, \qquad \forall \ket{n}, \ket{m} \in \{ \ket{h} \}
        \label{eq: ortonormalidad}
    \end{equation}
    \begin{equation}
        \| m \| = 1, \qquad \forall \ket{m} \in \{ \ket{h} \}
        \label{eq: linealidad}
    \end{equation}
    ...
    magnitud \( \mathcal{A}\) son los autovalores del operador A. En la definición de operador se
    pide que A sea hermítico, por lo que las cantidades medidas serían reales}.
